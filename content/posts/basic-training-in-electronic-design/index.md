...
lastmod: 2023-06-10
aliases:
- /2023/05/25/basic-training-in-electronic-design/
---
## PWM
...
![使用模拟引脚读取 PWM 信号](radio-pwm1.png)

但是，这个实验的结果很不精确，因为模拟引脚读取速度十分有限。使用示波器可以得到更为精确的结果：

![使用示波器读取 PWM 信号](radio-pwm2.jpg)
